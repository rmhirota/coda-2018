---
title: "Estatística básica e noções de inferência"
...
media <- c()
for (i in seq(1,1000)) {
  x_novo <- runif(1,min=-1, max=1)
  x <- append(x,x_novo)
  media <- append(media,mean(x))
}

plot(seq(1,1000),media, type = "l")
```
...
library(readr)
library(ggplot2)
dados <- read_csv("dados/expectativa.csv")
dados %>% ggplot() +
  geom_point(aes(x = TMI, y = Total)) +
  geom_smooth(aes(x = TMI, y = Total),method = "lm", formula = y ~ x, color = "red") +
  labs(x = "TMI", y = "Expectativa", title = "Expectativa de vida x Taxa de mortalidade infantil") +
  theme_bw()
```
...
dados %>% ggplot() +
  geom_point(aes(x = TMI, y = Total)) +
  geom_smooth(aes(x = TMI, y = Total),method = "lm", formula = y ~ x, color = "red", se = FALSE) +
  labs(x = "TMI", y = "Expectativa", title = "Expectativa de vida x Taxa de mortalidade infantil") +
  theme_bw()
...
dados %>% ggplot() +
  geom_point(aes(x = TMI, y = Total)) +
  geom_smooth(aes(x = TMI, y = Total),method = "lm", formula = y ~ x, color = "red", se=FALSE) +
  geom_abline(intercept = 85, slope = -0.65, color = "blue", size = 1.4) +
  labs(x = "TMI", y = "Expectativa", title = "Expectativa de vida x Taxa de mortalidade infantil") +
    theme_bw()
```
...
dados %>% ggplot() +
  ...
  geom_smooth(aes(x = TMI, y = Total),method = "lm", formula = y ~ x, color = "red", se=FALSE) +
  geom_abline(intercept = 85, slope = -0.65, color = "blue", size = 1.4) +
  geom_abline(intercept = 80, slope = -0.4, color = "green", size = 1.4) +
  labs(x = "TMI", y = "Expectativa", title = "Expectativa de vida x Taxa de mortalidade infantil") +
  theme_bw()
```
---
